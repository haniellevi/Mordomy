...
"[project]/src/app/api/incomes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        const lastItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].income.findFirst({
            where: {
                monthId
            },
            orderBy: {
        ...
        const income = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].income.create({
            data: {
                monthId,
                description,
        ...
        // Update Tithe
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$finance$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTithe"])(monthId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(income);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__930879d9._.js.map