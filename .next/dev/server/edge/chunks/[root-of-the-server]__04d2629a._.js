...
async function updateSession(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://adebouxbuqfbfcpzwnja.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFkZWJvdXhidXFmYmZjcHp3bmphIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM4MTQ2NjksImV4cCI6MjA3OTM5MDY2OX0.cLfAfbmP7xcvUAwOXI-6f_LmsVdCFmdUsjhHvhYCpUw"), {
        cookies: {
            getAll () {
    ...
    // Protected routes
    if (!user && !request.nextUrl.pathname.startsWith('/login') && !request.nextUrl.pathname.startsWith('/signup') && !request.nextUrl.pathname.startsWith('/landing') && request.nextUrl.pathname !== '/') {
